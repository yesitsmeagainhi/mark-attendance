    ...
    <>
      <section className="table-card">
        ...
        <div className="table-wrap">
          <table>
            <thead><tr><th>Employee</th><th>Contact</th><th>Job role</th><th>Work hours</th><th>Office</th><th>Salary</th><th>Status</th><th>Added</th></tr></thead>
            <tbody>
              {employeeList.map((emp) => {
                ...
                return (
                  <tr key={emp.id}>
                    ...
                    <td><span><b>{emp.email}</b><small>{emp.mobileNumber || "\u2014"}</small></span></td>
                    <td>{emp.jobRole || "\u2014"}</td>
              ...
              {employeeList.length === 0 && <tr><td colSpan={8} style={{ textAlign: "center", color: "#8990a0", padding: 30 }}>No employees registered yet.</td></tr>}
            </tbody>
          </table>
        </div>
      </section>
