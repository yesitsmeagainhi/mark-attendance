            ...
            {tsData && (
              <section className="timesheet-summary">
                ...
                {(tsData.sundayWorkedDays ?? 0) > 0 && (
                  <article className="emp-status-card">
                    <div className="emp-status-header"><b>Sun Work</b></div>
    ...
    <>
      ...
      <section className="metrics">
        ...
        {(data.sundayWorkedDays ?? 0) > 0 && (
          <article><span className="metric-icon green">&#9733;</span><div><small>Sun Work</small><strong>{data.sundayWorkedDays}</strong><em>days</em></div></article>
        )}
      </section>
